...
def note_search(imgpath):
    ...
    sort_list=sort_staff_note(staff_average_line,scale_note_list,startlist)
...
def sort_staff_note(staff_average, notelist,start_list):
    '''
    m=0
    num=0
    start_list = []
...
def note_scale(staff_list,notelist,start_list):
    ...
    for y in range(len(notelist)):
        ...
        if(staff_list[5*i]-3<notelist[y][1]<staff_list[5*i]+3):
            #print("1미",notelist[y][1],staff_list[5*i])
            #scale_list.append("1미")
            notelist[y].insert(3,"1미")
        
        elif(staff_list[5*i]+3<notelist[y][1]<staff_list[5*i+1]-3):
            #print("1레",notelist[y][1],staff_list[5*i]+gap)
            #scale_list.append("1레")
            notelist[y].insert(3,"1레")

        elif(staff_list[5*i+1]-3<notelist[y][1]<staff_list[5*i+1]+3):
            #print("1도",notelist[y][1],staff_list[5*i+1])
            #scale_list.append("1도")
            notelist[y].insert(3,"1도")

        elif(staff_list[5*i+1]+3<notelist[y][1]<staff_list[5*i+2]-3):
            #print("2시",notelist[y][1],staff_list[5*i+1]+gap)
            #scale_list.append("2시")
            notelist[y].insert(3,"2시")

        elif(staff_list[5*i+2]-3<notelist[y][1]<staff_list[5*i+2]+3):
            #print("2라",notelist[y][1],staff_list[5*i+2])
            #scale_list.append("2라")
            notelist[y].insert(3,"2라")

        elif(staff_list[5*i+2]+3<notelist[y][1]<staff_list[5*i+3]-3):
            #print("2솔",notelist[y][1],staff_list[5*i+2]+gap)
            #scale_list.append("2솔")
            notelist[y].insert(3,"2솔")

        elif(staff_list[5*i+3]-3<notelist[y][1]<staff_list[5*i+3]+3):
            #print("2파",notelist[y][1],staff_list[5*i+3])
            #scale_list.append("2파")
            notelist[y].insert(3,"2파")

        elif(staff_list[5*i+3]+3<notelist[y][1]<staff_list[5*i+4]-3):
            #print("2미",notelist[y][1],staff_list[5*i+3]+gap)
            #scale_list.append("2미")
            notelist[y].insert(3,"2미")

        elif(staff_list[5*i+4]-3<notelist[y][1]<staff_list[5*i+4]+3):
            #print("2레",notelist[y][1],staff_list[5*i+4])
            #scale_list.append("2레")
            notelist[y].insert(3,"2레")

        elif(staff_list[5*i+4]+3<notelist[y][1]<staff_list[5*i+4]+10):
            #print("2도",notelist[y][1],staff_list[5*i+4]+gap)
            #scale_list.append("2도")
            notelist[y].insert(3,"2도")
