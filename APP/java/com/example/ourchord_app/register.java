...
public class register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String auth = AUTH.getText().toString();
        ...
        double_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                System.out.println("사용자 입력한 아이디 중복 확인 위해 전송");
        ...
        register_btn.setOnClickListener(new View.OnClickListener() {
            ...
            connect_regis_confirm(name, id, pwd, email);
    ...
    // 중복 확인
    void connect_id_check(final String ID){
    ...
    // 데이터베이스(서버) 전송
    void connect_regis_confirm(final String Name, final String Id, final String Pwd, final String Email) {
        mHandler = new Handler();
        Log.w("connect", "연결 하는중");

        Thread REGIS_CONFIRM = new Thread() {
            public void run() {
                try {
                    socket = new Socket(ip, port);
                    Log.w("서버 접속됨", "서버 접속됨");
                ...
                try {
                    ...
                    String RegisterInfo = Name + "-" + Id + "-" + Pwd + "-" + Email;
